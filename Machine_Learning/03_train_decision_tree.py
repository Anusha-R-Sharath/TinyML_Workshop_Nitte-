...
X = df.iloc[:, :-1] #all rows expet last column, 15000/6 matrix for the data collected
y = df.iloc[:, -1]  #all rows and last column/, 15000/1 vector for the data collected
...
X_train, X_test, y_train, y_test = train_test_split(
    X,
    y,
    test_size=0.20, #20% of data collected, i.e., 3000 samples/ 15000, usually 80% training and 20% testing
    random_state=42,
    stratify=y,
    shuffle=True
)
